...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--pretrained_model', type=str, default='./checkpoints/experiment_name/ckpt.pth', help='model will fine tune on it if fine-tune is True')
        parser.add_argument('--fine-tune', type=bool, default=True)
        parser.add_argument('--weight_decay', type=float, default=0.0, help='weight decay for optimizer')
        parser.add_argument('--class_bal', action='store_true', help='use class balanced sampling')
        self.isTrain = True
